...
<body>
    ...
    <p>
        ...
        EL 구문을 사용하면 표현하고자 하는 값을 ${name}의 형식으로 출력할 수 있다. <br>
        EL은 기존 표현식보다 간결하고 null처리에 안전하다. <br>
    </p>
    ...
    <%-- 
        ...
        3. 액션 태그(Action Tag)
            ...
            >> 표준 액션 태그 : <jsp:태드명><태그명>이런식으로 jsp: 이라는 접두어를 사용
            >> 커스텀 액션 태그 : 별도로 라이브러리로 등록하여 사용하는 태그(JSTL등...)
    --%>
