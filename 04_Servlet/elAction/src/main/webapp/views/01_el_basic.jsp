...
<body>
    <h1>1. 기존 방식대로 jsp 문법 사용하여 각 scope의 데이터를 출력</h1>
<%-- 
    <%
        //request scope
...
--%>
    ...
    <p>
        EL을 이용하여 getter를 통해 가져올 필요없이 EL 구문내의 키만을 제시하면 바로 접근 가능 <br>
        EL은 jsp의 scope를 구분하지 않고 자동으로 모든 scope의 키를 검색하여 존재하는 경우 그값을 가져옴 <br>
    </p>
    ...
    <p>EL은 공유 범위가 가장 작은 스코프부터 해당 키 값을 검색함(page -> request -> session -> apllication)</p>
    test값 : ${test}
