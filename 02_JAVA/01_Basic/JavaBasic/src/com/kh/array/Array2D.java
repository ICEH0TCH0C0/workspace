...
public class Array2D {
	...
	public static void main(String[] args) {
		...
		//2차원 배열 선언(1차원 배열의 묶음을 참조하는 2차원배열의 참조변수 선언)
		//자료형[][] 배열명
		int[][] arr;
		...
		arr = new int[2][3]; 
		//arr라는 2차원 배열에 2행 3열의 메모리 구조가 바로 할당
		//3개짜리 1차원 배열 2개가 생성
		//대부분 사용하는 방식
		...
		/*
		 * arr = new int[3][]; //1차원 배열의 참조변수만 3개 생성 arr[0] = new int[5]; arr[1] = new
		 * int[3]; arr[2] = new int[2];
		 */
