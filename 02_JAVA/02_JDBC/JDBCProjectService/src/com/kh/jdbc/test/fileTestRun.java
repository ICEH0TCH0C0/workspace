...
public class fileTestRun {
	...
	public static void main(String[] args) {
		/*
		 * Properties
		 * Properties 클래스는 Map계열의 컬렉션으로, key-value형식으로 데이터를 저장/읽기할 수 있음.
		 * 특히 외부파일(.properties / .xml)을 통해서 데이터를 쉽게 관리하고 불러올 수 있음.
		 * DB연결정보, 프로그램 설정정보(port, 환경변수 ...), sql쿼리문 등을 코드와 분리해서 관리할 때 주로 사용
		 * */
		...
		*/
		...
		try {
			...
			System.out.println(propXml.getProperty("keywordSerch"));
		} catch (IOException e) {
			e.printStackTrace();
		}
