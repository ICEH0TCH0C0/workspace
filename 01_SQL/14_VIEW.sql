...
--일본에서 근무하는 사원들의 사번, 이름, 부서명, 급여, 근무 국가 조회
SELECT EMP_ID, EMP_NAME, DEPT_TITLE, SALARY, NATIONAL_NAME
FROM EMPLOYEE
JOIN DEPARTMENT ON DEPT_CODE = DEPT_ID
JOIN LOCATION ON LOCATION_ID = LOCAL_CODE
...
--GRANT CREATE VIEW TO C##SERVER; 관리자 권한으로 뷰 생성 권한을 C##SERVER에 부여
...
--뷰를 통해서 조작하면 실제 테이터가 담겨있는 테이블에 반영됨
...
/*
    ...
    [표현법]
        ...
        WITH READ ONLY : 뷰에 대하여 조회만 가능하도록 함
*/
